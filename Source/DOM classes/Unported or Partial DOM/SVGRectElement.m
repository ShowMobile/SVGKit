...
void SVGCGPathAddRoundedRect (CGMutablePathRef path, CGRect rect, CGFloat radiusX, CGFloat radiusY);
...
- (void)postProcessAttributesAddingErrorsTo:(SVGKParseResult *)parseResult {
	...
	else
	{
		...
		SVGCGPathAddRoundedRect(path, rect, radiusXPixels, radiusYPixels);
	}
